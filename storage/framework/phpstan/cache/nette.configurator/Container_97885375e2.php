...
class Container_97885375e2 extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_97885375e2 $container)
			{
	...
	public function createServiceContainer(): Container_97885375e2
	{
		return $this;
	}
