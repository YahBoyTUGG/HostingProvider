...
class Container_1486a5e147 extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_1486a5e147 $container)
			{
	...
	public function createServiceContainer(): Container_1486a5e147
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'BIN_TARGET' => 'C:\Users\popot\Desktop\Delovna_Praksa\backend\hosting-app\vendor\bin\/phpstan',
				'CHROME_CRASHPAD_PIPE_NAME' => '\\\.\pipe\crashpad_11448_DFGVZORSYBFRQEEU',
				'COLUMNS' => '80',
				'COMPOSER_RUNTIME_BIN_DIR' => 'C:\Users\popot\Desktop\Delovna_Praksa\backend\hosting-app\vendor\bin\\',
				'COMPUTERNAME' => 'FILIP',
